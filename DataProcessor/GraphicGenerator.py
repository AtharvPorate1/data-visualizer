...
class GraphicGenerator:
    ...
    def linearRegressionPlot(_self):
        st.markdown('### Linear Regression Plots')
        columns_regression_x = st.multiselect('Columns for the X axis: ', _self.columns, default=None, key='x_reg')
        columns_regression_y = st.multiselect('Columns for the Y axis: ', _self.columns, default=None, key='y_reg')
